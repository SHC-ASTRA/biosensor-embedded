...
#
# Script generated by Vivado on Wed Apr 01 20:48:39 CDT 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../../../../../Documents/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../../../../../Documents/2025.2/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ozy/projects/biosensor-embedded/au_fpga_timer/cores/managed_ip_project/managed_ip_project.cache/compile_simlib/vcs"
  fi
